...
function updateLightbox(wallpaper) {
	...
	const isGif = wallpaper.full.toLowerCase().endsWith('.gif');
	...
	if (isGif || !highResUrl) {
		...
		img.onerror = () => {
			wallpaperRes.textContent = 'Image failed to load.';
			contentElement.classList.remove('loading');
			img.style.opacity = 1;
		};
		return;
        ...
        <div class="lightbox-main-wrapper">
            ...
            <div class="lightbox-details">
                ...
                <div class="lightbox-actions">
                    ...
                    <a href="${encodedDownloadUrl}" download="${wallpaper.name}" class="download-btn">Download</a>
                </div>
            </div>
        </div>
